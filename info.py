...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://rahat:rahat@rahat.ncjti.mongodb.net/?retryWrites=true&w=majority&appName=Rahat")   # IF Multiple Database Is False Then Fill Only This Database Url.
