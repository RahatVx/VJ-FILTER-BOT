...
PICS = (environ.get('PICS', 'https://envs.sh/GW2.jpg')).split() #SAMPLE PIC
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://rohanahamed75:gt4RXJZ1mUtOh4Xv@mmtg.0ong5.mongodb.net/?retryWrites=true&w=majority&appName=mmtg")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Rm_Support_Groups') # Support Chat Link Without https:// or @
...
MSG_ALRT = environ.get('MSG_ALRT', 'Hello My Dear Friends ❤️ Join @RM_Movie_Flix')
